...
LINKLIB =   qr_test.o pdgeqrrv.o pdmatgen.o pmatgeninc.o pdlaprnt.o orig_pdgeqrf.o ft_pdgeqrf0.o ft_pdgeqrf.o util_ft.o ft_pdlarfb.o $(FASTBLASLIB)

PROG = qr_test.x

$(PROG) : qr_test.o pdgeqrrv.o pdmatgen.o pmatgeninc.o pdlaprnt.o util_ft.o orig_pdgeqrf.o ft_pdgeqrf0.o ft_pdgeqrf.o ft_pdlarfb.o 
